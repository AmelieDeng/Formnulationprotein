...
from tools import summarize_model_with_hierarchy_and_info, scale_form_one, scale_form_one_refit, EarlyStopping_class, plot_training_curves, plot_training_curves_refit, get_params_with_weight_decay
...
def train_model(model, optimizer, scheduler, early_stopping, criterion, data_loader, device, epochs, fold, trial, time_log_file, train_curve_plot_path):
    ...
    best_result = None
    best_epoch, best_val_loss, best_test_loss = 0, 0, 0
    epoch_results = []
    best_result = []
